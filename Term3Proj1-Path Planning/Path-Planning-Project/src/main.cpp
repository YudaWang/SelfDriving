          ...
          // j[1] is the data JSON object
            ...
            for(int i=0; i<sensor_fusion.size(); i++){
              ...
              if(d<(2+4*lane+2) && d>(2+4*lane-2)){
                ...
                double check_car_s = sensor_fusion[i][5];
                double check_end_path_s = check_car_s + prev_size*0.02*check_speed;
                if(check_end_path_s-end_path_s>-20 && check_end_path_s-end_path_s<30){ // if potential collision
                  too_close_left = true;
                }
            ...
            // if previous size is ~empty, use car location as starting ref
            if(prev_size<2)
            {
            ...
            else // if previous_path size enough, use last 2 locations
            {
            ...
            for (int i = 1; i<= 50-previous_path_x.size(); i++)
            {
              ...
              // rotate back to normal ref-frame
